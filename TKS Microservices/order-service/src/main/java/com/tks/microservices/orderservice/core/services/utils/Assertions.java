package com.tks.microservices.orderservice.core.services.utils;
...
public class Assertions {
    ...
    public static <T, R, EX extends RuntimeException> void assertTrue(Function<T, R> func , List<T> val, EX toThrowIfFails) throws EX {
        if(val.stream().allMatch(value -> func.apply(value).equals(false))){
            throw toThrowIfFails;
        }
    }
